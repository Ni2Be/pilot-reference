...
## How to use?
1. Click on the map (or use the search) to select the region you want the airports from and hit "Find Nearby"
2. Check/Uncheck filter as you like (e.g. to only include heliports)
